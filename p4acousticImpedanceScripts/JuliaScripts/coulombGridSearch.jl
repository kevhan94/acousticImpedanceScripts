...
# Define Coulomb friction coefficient
...
for iSite in 1:nSites
    ...
    # Loop over sliding law parameter (mu)
    for iSLV=1:nSLV

    	# Calculate effective pressure
    	effectivePressure = tauBedSmooth3ptTri / coulombFrictionCoeffList[iSLV];
	...
	if count(pressureExceeds) > 0
	   ...
	   println("Site: ", iSite, ", SLV: ", coulombFrictionCoeffList[iSLV])
...
NetCDFfile = "coulombGridSearch.nc";
